...
{% include readinggroupevent.html date="Nov. 10th" volunteer="Noah Curran" authors="" title="" pubvenue="TBD" year="" url="" %}
{% include readinggroupevent.html date="Nov. 3rd" volunteer="Ryan Feng" authors="Sabbir Ahmed, et al" title="DFR-TSD: A Deep Learning Based Framework for Robust Traffic Sign Detection Under Challenging Weather Conditions" pubvenue="IEEE Trans. on Intelligent Transportation Systems" year="2022" url="https://ieeexplore.ieee.org/abstract/document/9345465" %}
